...
$query = "SELECT * FROM products WHERE product_category = 'Sides'";
        ...
        <div class="modal-content">
            ...
            <div class="customization-section">
                ...
                <div class="options-container">
                    <?php
                    $options = [
                        ['id' => 'option-burger-only', 'value' => 'Burger Only', 'label' => 'Side  Only'],
            ...
            <div class="customization-section">
                ...
                <div class="addons-container">
                    ...
                    $addons = [
                        ...
                        ['id' => 'addon-bacon', 'value' => 'Onion Rings', 'price' => 30],
                        ['id' => 'addon-avocado', 'value' => 'Mozzarella Sticks', 'price' => 30],
                        ['id' => 'addon-jalapenos', 'value' => 'Jalapeños', 'price' => 30],
                        ['id' => 'addon-mushrooms', 'value' => 'Side Salad', 'price' => 30],
                        ['id' => 'addon-onion-rings', 'value' => 'Ranch', 'price' => 30]
                    ];
                    foreach ($addons as $addon) {
