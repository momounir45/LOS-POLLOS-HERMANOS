        ...
        <form id="orderForm" method="post" action="process_order.php">
            ...
            <div class="customization-section">
                ...
                <div class="options-container">
                    <?php
                    $options = [
                        ['id' => 'option-burger-only', 'value' => 'Burger Only', 'label' => 'Burger Only'],
            ...
            <div class="customization-section">
                ...
                <div class="addons-container">
                    <?php
                    $addons = [
                        ['id' => 'addon-extra-cheese', 'value' => 'Extra Cheese', 'price' => 20],
                        ['id' => 'addon-bacon', 'value' => 'Extra Bacon', 'price' => 30],
                        ['id' => 'addon-avocado', 'value' => 'Avocado', 'price' => 25],
                        ['id' => 'addon-jalapenos', 'value' => 'Jalapeños', 'price' => 15],
                        ['id' => 'addon-mushrooms', 'value' => 'Extra Mushrooms', 'price' => 20],
                        ['id' => 'addon-onion-rings', 'value' => 'Onion Rings', 'price' => 25]
                    ];
    ...
    document.body.style.overflow = 'hidden';
        ...
        function addToCart() {
            ...
            console.log('Added to cart:', {
                item: document.getElementById('modalName').textContent,
                basePrice: document.getElementById('modalPrice').textContent,
                size,
                mealOption,
                addons,
                specialRequests,
            ...
            // Show confirmation (in a real app, you might update a cart counter)
