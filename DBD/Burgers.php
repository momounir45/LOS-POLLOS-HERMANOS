...
$query = "SELECT * FROM products WHERE product_category = 'Burgers'";
        ...
        <div class="modal-content">
            ...
            <div class="customization-section">
                ...
                <div class="options-container">
                    <?php
                    $sizes = [
                        ['id' => 'size-regular', 'value' => 'Regular', 'label' => 'Single '],
                        ['id' => 'size-large', 'value' => 'Large', 'label' => 'Double (+EGP 30)']
                    ];
            ...
            <div class="customization-section">
                ...
                <div class="addons-container">
                    ...
                    $addons = [
                        ...
                        ['id' => 'addon-avocado', 'value' => 'Caramelized Onions', 'price' => 30],
                        ['id' => 'addon-jalapenos', 'value' => 'Jalapeños', 'price' => 30],
                        ['id' => 'addon-mushrooms', 'value' => 'Extra Mushrooms', 'price' => 30],
                        ['id' => 'addon-onion-rings', 'value' => 'Onion Rings', 'price' => 30]
                    ];
                    foreach ($addons as $addon) {
