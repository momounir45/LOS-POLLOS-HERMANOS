...
$query = "SELECT * FROM products WHERE product_category = 'Desserts'";
        ...
        <div class="modal-content">
            ...
            <div class="customization-section">
                ...
                <div class="options-container">
                    <?php
                    $options = [
                        ['id' => 'option-burger-only', 'value' => 'Burger Only', 'label' => 'Dessert  Only'],
                        ['id' => 'option-with-fries', 'value' => 'With Fries', 'label' => 'With Coffee (+EGP 40)'],
                        ['id' => 'option-with-drink', 'value' => 'With Drink', 'label' => 'With Cookie (+EGP 30)'],
            ...
            <div class="customization-section">
                ...
                <div class="addons-container">
                    <?php
                    $addons = [
                        ['id' => 'addon-extra-cheese', 'value' => 'Whipped Cream', 'price' => 30],
                        ['id' => 'addon-bacon', 'value' => 'Sprinkles ', 'price' => 30],
                        ['id' => 'addon-avocado', 'value' => 'Caramel Sauce ', 'price' => 30],
                        ['id' => 'addon-jalapenos', 'value' => 'Chocolate Sauce', 'price' => 30],
                        ['id' => 'addon-mushrooms', 'value' => 'Nuts ', 'price' => 30],
                        ['id' => 'addon-onion-rings', 'value' => 'Fresh Fruit', 'price' => 30]
                    ];
                    foreach ($addons as $addon) {
